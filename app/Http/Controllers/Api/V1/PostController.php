    ...
    // total comments
      ...
      if($post_user->user->id!=$request->user_id){
       if(!empty($post_user->user->device_token)){
        SendAllNotification($post_user->user->device_token,$message,'social_notification','add_comment');          
      }
...
public function GetComments(Request $request){
  ...
  // total likes
       ...
       if($post_user->user->id!=$request->user_id){ 
         ...
         if(!empty($post_user->user->device_token)){
          SendAllNotification($post_user->user->device_token,$message,'social_notification','like_post');        
        }
