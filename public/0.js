...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  SaveTeacher: function SaveTeacher(_ref7, data) {
    var commit = _ref7.commit;
    console.log(data);
    return new Promise(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].post("/api/auth/signup_teacher", data).then(function (response) {
        resolve(response);
      })["catch"](function (error) {
        reject(error);
      });
  ...
  SaveParent: function SaveParent(_ref8, data) {
  ...
  removeRecord: function removeRecord(_ref9, userId) {
  ...
  //admin functions 
  fetchAdminUsers: function fetchAdminUsers(_ref10) {
  ...
  fetchSchoolAdmins: function fetchSchoolAdmins(_ref11) {
  ...
  fetchAdminStudents: function fetchAdminStudents(_ref12) {
  ...
  fetchAdminParents: function fetchAdminParents(_ref13) {
