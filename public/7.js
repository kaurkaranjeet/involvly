  ...
  methods: {
    logout: function logout() {
      ...
      if (localStorage.getItem('role_id') == 5) {
        ...
        localStorage.removeItem('role_id');
        this.$router.push('/pages/admin/login')["catch"](function () {});
  ...
  computed: {
    ...
    menuItemsUpdated: function menuItemsUpdated() {
      if (localStorage.getItem("role_id") == '1') {
        var clone = this.adminNavMenuItems.slice();

        var _iterator = _createForOfIteratorHelper(this.adminNavMenuItems.entries()),
            _step;
        ...
        var _clone = this.navMenuItems.slice();

        var _iterator3 = _createForOfIteratorHelper(this.navMenuItems.entries()),
            _step3;
        ...
        try {
          var _loop2 = function _loop2() {
            ...
            if (item.header && item.items.length && (index || 1)) {
              var i = _clone.findIndex(function (ix) {
                return ix.header === item.header;
              });

              var _iterator4 = _createForOfIteratorHelper(item.items.entries()),
                  _step4;

              try {
                for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                  var _step4$value = _slicedToArray(_step4.value, 2),
                      subIndex = _step4$value[0],
                      subItem = _step4$value[1];

                  _clone.splice(i + 1 + subIndex, 0, subItem);
                }
              } catch (err) {
                _iterator4.e(err);
              } finally {
...
/* harmony import */ var _layouts_components_vertical_nav_menu_adminNavMenuItems_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/layouts/components/vertical-nav-menu/adminNavMenuItems.js */ "./resources/js/src/layouts/components/vertical-nav-menu/adminNavMenuItems.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      adminNavMenuItems: _layouts_components_vertical_nav_menu_adminNavMenuItems_js__WEBPACK_IMPORTED_MODULE_3__["default"],
  ...
  computed: {
    ...
    accessRole: function accessRole() {
      if (localStorage.getItem("role_id") == '1') {
        return true;
      } else {
        return false;
  ...
  return _c(
    ...
    [
      ...
      _vm.accessRole
        ? _c("v-nav-menu", {
            attrs: {
              adminNavMenuItems: _vm.adminNavMenuItems,
              title: "Involvvely",
              parent: ".layout--main"
            }
          })
            ...
            ? [
                ...
                _vm.accessRole
                  ? _c("h-nav-menu", {
                      ...
                      attrs: { adminNavMenuItems: _vm.adminNavMenuItems }
                    })
                  : _vm._e()
              ]
            : [
...
/***/ "./resources/js/src/layouts/components/vertical-nav-menu/adminNavMenuItems.js":
/*!************************************************************************************!*\
  !*** ./resources/js/src/layouts/components/vertical-nav-menu/adminNavMenuItems.js ***!
  \************************************************************************************/
/*! exports provided: default */
