<!-- =========================================================================================
  File Name: SubjectList.vue
  Description: Subject List page
  ----------------------------------------------------------------------------------------
...
<template>
    <div id="page-user-list">
        ...
        <div class="vx-card p-6">
            ...
            <!-- AgGrid Table -->
            <ag-grid-vue ref="agGridTable" :components="components" :gridOptions="gridOptions" class="ag-theme-material w-100 my-4 ag-grid-table class-width-subject" :columnDefs="columnDefs" :defaultColDef="defaultColDef" :rowData="usersData" rowSelection="multiple" colResizeDefault="shift"
...
export default {
    ...
    created() {
        ...
        this.$store.dispatch('subjectManagement/fetchSchoolSubjects', localStorage.getItem('school_id')).catch(err => { console.error(err) })
    }
}
</script>
