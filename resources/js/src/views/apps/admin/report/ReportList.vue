<!-- =========================================================================================
  File Name: TeacherList.vue
  Description: Teacher List page
  ----------------------------------------------------------------------------------------
...
export default {
  ...
  computed: {
    ...
    usersData () {
      console.log("czxczxc",this.$store.state.userManagement.report_users);
      return this.$store.state.userManagement.report_users
    },
    paginationPageSize () {
  ...
  created () {
    ...
    this.$store.dispatch('userManagement/fetchReportUsers').catch(err => { console.error(err) })
  }
}
