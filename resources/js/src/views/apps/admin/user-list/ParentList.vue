    ...
    <div class="vx-card p-6">
      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="flex-grow">
          ...
          <div v-if="usersData.length - currentPage * paginationPageSize == '0'" class="p-4 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
...
import CellRendererActionsParents from './cell-renderer/CellRendererActionsParents.vue'
...
export default {
  ...
  created () {
    ...
    this.$store.dispatch('userManagement/fetchAdminParents').catch(err => { console.error(err) })
  }
}
