...
import CellRendererActionsSchoolAdmins from './cell-renderer/CellRendererActionsSchoolAdmins.vue'
...
export default {
  components: {
    ...
    CellRendererActionsSchoolAdmins
  },
  data () {
    return {
  ...
  created () {
    ...
    this.$store.dispatch('userManagement/fetchSchoolAdmins').catch(err => { console.error(err) })
  }
}
