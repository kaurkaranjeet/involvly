...
<template>
    <div id="page-user-list">
        <div class="col-md-12 bg-light text-right pd-bt">
            <vs-button color="primary" type="filled" to="/apps/class/class-add">Add Class Code</vs-button>
        </div>
        ...
        <div class="vx-card p-6">
            ...
            <!-- AgGrid Table -->
            <ag-grid-vue ref="agGridTable" :components="components" :gridOptions="gridOptions" class="ag-theme-material w-100 my-4 ag-grid-table class-width-classlist" :columnDefs="columnDefs" :defaultColDef="defaultColDef" :rowData="usersData" rowSelection="multiple" colResizeDefault="shift"
...
export default {
    ...
    created() {
        ...
        this.$store.dispatch('classManagement/fetchClassCode').catch(err => { console.error(err) })
    }
}
</script>
